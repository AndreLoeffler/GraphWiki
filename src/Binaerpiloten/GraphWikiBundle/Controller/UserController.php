...
use Binaerpiloten\GraphWikiBundle\Entity\User;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BinaerpilotenGraphWikiBundle:User')->findAll();
    ...
    public function showAction($id)
    {
    	...
    	$entity = $em->getRepository('BinaerpilotenGraphWikiBundle:User')->find($id);
